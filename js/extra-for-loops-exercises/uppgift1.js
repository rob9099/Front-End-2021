/*
När vi använder while-loopar kan vi få den att gå ett exakt antal gånger. Detta är dock inte optimalt då en
while körs så länge ett påstående är sant och för detta har vi istället for-loopen.
