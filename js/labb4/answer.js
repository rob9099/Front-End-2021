 ...
 */
 ...
 var person = {firstName: 'Isaac', print1(){return `My name is ${this.firstName}.`;}}
...
person.print2 = function print2() {return `My name is ${this.firstName} ${this.lastName} from ${this.nationality}.`;};
...
//person.born = new Date(1643, 1, 4, 0, 0, 0);
person.born = new Date('1643-01-04');
person.print3 = function print3() {return `My name is ${this.firstName} ${this.lastName} from ${this.nationality}. I was born ${this.born.getFullYear()}.`;};
 ...
 */
 ...
 person.init = function (firstName, lastName, nationality, born) {
    {return `${this.firstName = firstName}  ${this.lastName = lastName}  ${this.nationality = nationality}  ${this.born = new Date (born)}`;}
}
